...
void main(){
    ...
    SPI_Write(0x0A, 0b00101000);
    SPI_Write(0x00, 0b00000000);
    SPI_Write(0x01, 0b00000000);
    SPI_Write(0x12, MCP_GPIOA);
    SPI_Write(0x13, MCP_GPIOB);
    ...
    uint8_t bypass = 0;
# 171 "main.c"
    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00000100);
    ...
    for(;;){
        for(db_cnt = 0; db_cnt <= 10; db_cnt++){
            ...
            if (RC0 == 1 && RC1 == 1 && RC2 == 1 && RC3 == 1 && RC4 == 1 && RC5 == 1 && RB7 == 1 && RB4 == 1){
                db_cnt = 0;
            }
        }
        ...
        if(RC0 == 0){
            ...
            bypass_update_flag = 1;
        }


        else if(RB4 == 0){
            if(mode == 0){
                MCP_GPIOB = MCP_GPIOB | 0b00000001;
                MCP_GPIOB = MCP_GPIOB | 0b00000010;
                MCP_GPIOB = MCP_GPIOB | 0b00000100;
                MCP_GPIOA = MCP_GPIOA | 0b00000001;
                MCP_GPIOA = MCP_GPIOA | 0b00000010;
                mode = 1;
                MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00000100);
            }
            else{
                mode = 0;
                MCP_GPIOA = EEPROM_Read(0x01);
                MCP_GPIOB = EEPROM_Read(0x05);
                MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00000001);
                MCP_GPIOA = MCP_GPIOA | 0b00000100;
            }
        }
            ...
            if(mode == 1){
                ...
                for(db_cnt = 0; db_cnt <= 10; db_cnt++){
                    _delay((unsigned long)((2)*(8000000/4000.0)));
                    if (RC0 == 1 && RC1 == 1 && RC2 == 1 && RC3 == 1 && RC4 == 1 && RC5 == 1){
                        db_cnt = 0;
                    }
                }
                ...
                if(RC1 == 0){
                    ...
                    EEPROM_Write(0x01, MCP_GPIOA);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    EEPROM_Write(0x05, MCP_GPIOB);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    ...
                    EEPROM_Write(0x09, MCP_GPIOA);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    EEPROM_Write(0x0D, MCP_GPIOB);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                }
                else if(RC3 == 0){
                    ...
                    EEPROM_Write(0x11, MCP_GPIOA);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    EEPROM_Write(0x15, MCP_GPIOB);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                }
                else if(RC4 == 0){
                    ...
                    EEPROM_Write(0x19, MCP_GPIOA);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    EEPROM_Write(0x1D, MCP_GPIOB);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                }
                else if(RC5 == 0){
                    ...
                    EEPROM_Write(0x21, MCP_GPIOA);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    EEPROM_Write(0x25, MCP_GPIOB);
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                }

                for(db_cnt = 0; db_cnt <= 10; db_cnt++){
                    _delay((unsigned long)((2)*(8000000/4000.0)));
                    if (RC0 == 0 || RC1 == 0 || RC2 == 0 || RC3 == 0 || RC4 == 0 || RC5 == 0){
                        db_cnt = 0;
                    }
                }
            }
        ...
        if(mode == 1 && bypass_update_flag == 0){
            if(RC1 == 0){
                if((MCP_GPIOB & 0b00001000) == 0){
                    MCP_GPIOB = MCP_GPIOB | 0b00001000;
                    MCP_GPIOA = MCP_GPIOA | 0b00001000;
                }
                else{
                    MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00001000);
                    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00001000);
                ...
                if((MCP_GPIOB & 0b00010000) == 0){
                    MCP_GPIOB = MCP_GPIOB | 0b00010000;
                    MCP_GPIOA = MCP_GPIOA | 0b00010000;
                }
                else{
                    MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00010000);
                    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00010000);
                ...
                if((MCP_GPIOB & 0b00100000) == 0){
                    MCP_GPIOB = MCP_GPIOB | 0b00100000;
                    MCP_GPIOA = MCP_GPIOA | 0b00100000;
                }
                else{
                    MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00100000);
                    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00100000);
                ...
                if((MCP_GPIOB & 0b01000000) == 0){
                    MCP_GPIOB = MCP_GPIOB | 0b01000000;
                    MCP_GPIOA = MCP_GPIOA | 0b01000000;
                }
                else{
                    MCP_GPIOB = ~(~(MCP_GPIOB) | 0b01000000);
                    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b01000000);
                ...
                if((MCP_GPIOB & 0b10000000) == 0){
                    MCP_GPIOB = MCP_GPIOB | 0b10000000;
                    MCP_GPIOA = MCP_GPIOA | 0b10000000;
                }
                else{
                    MCP_GPIOB = ~(~(MCP_GPIOB) | 0b10000000);
                    MCP_GPIOA = ~(~(MCP_GPIOA) | 0b10000000);
        ...
        else if(mode == 0 && bypass_update_flag == 0){
            MCP_GPIOB = MCP_GPIOB | 0b00000001;
            MCP_GPIOB = MCP_GPIOB | 0b00000010;
            MCP_GPIOB = MCP_GPIOB | 0b00000100;
            MCP_GPIOA = MCP_GPIOA | 0b00000001;
            ...
            if(RC1 == 0){
                ...
                MCP_GPIOA = EEPROM_Read(0x09);
                MCP_GPIOB = EEPROM_Read(0x0D);
                MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00000010);
                MCP_GPIOA = MCP_GPIOA | 0b00000100;
            }
            else if(RC3 == 0){
                MCP_GPIOA = EEPROM_Read(0x11);
                MCP_GPIOB = EEPROM_Read(0x15);
                MCP_GPIOB = ~(~(MCP_GPIOB) | 0b00000100);
                MCP_GPIOA = MCP_GPIOA | 0b00000100;
            }
            else if(RC4 == 0){
                MCP_GPIOA = EEPROM_Read(0x19);
                MCP_GPIOB = EEPROM_Read(0x1D);
                MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00000001);
                MCP_GPIOA = MCP_GPIOA | 0b00000100;
            }
            else if(RC5 == 0){
                MCP_GPIOA = EEPROM_Read(0x21);
                MCP_GPIOB = EEPROM_Read(0x25);
                MCP_GPIOA = ~(~(MCP_GPIOA) | 0b00000010);
                MCP_GPIOA = MCP_GPIOA | 0b00000100;
            }
            else if(RB4 == 0){
        ...
        SPI_Write(0x12, MCP_GPIOA);
        SPI_Write(0x13, MCP_GPIOB);
        bypass_update_flag = 0;


        for(db_cnt = 0; db_cnt <= 10; db_cnt++){
            _delay((unsigned long)((2)*(8000000/4000.0)));
            if (RC0 == 0 || RC1 == 0 || RC2 == 0 || RC3 == 0 || RC4 == 0 || RC5 == 0 || RB7 == 0 || RB4 == 0){
                db_cnt = 0;
            }
        }
